...
#define IDENTITY_DREAM_URI @"https://keystone.dream.io/"
...
- ( id ) init
{
    ...
    serviceRootURL = IDENTITY_DREAM_URI;
    versionMajor = @2;
    versionMinor = @0;
    providerName = @"Dreamhost";
    
    iostackV2Manager = [IOStackAuthV2 initWithIdentityURL:IDENTITY_DREAM_URI];
