...
@interface IOStackBStorage_INAPTests : XCTestCase

@end


@implementation IOStackBStorage_INAPTests
{
...
- ( void ) setUp
{
    ...
    XCTAssertNotNil( dicSettingsTests[ @"INAP_BLOCKSTORAGE_ROOT" ] );
                                              ...
                                              thenDo:^(NSString * _Nullable strTokenIDResponse, NSDictionary * _Nullable dicFullResponse)
    {
        ...
        bstorageV2Test = [IOStackBlockStorageV2 initWithIdentity:authINAP];
...
- ( void ) testINAPBStorageNotASingleton
{
    XCTAssertNotNil( bstorageV2Test.currentTokenID );
    
    IOStackBlockStorageV2 *    bstorageV2Test2 = [IOStackBlockStorageV2 initWithBlockStorageURL:dicSettingsTests[ @"INAP_BLOCKSTORAGE_ROOT" ]
...
- ( void ) testINAPBStorageCreateListAndDeleteVolume
{
...
- ( void ) testINAPBStorageCreateListAndDeleteVolumeWithDetails
{
    __weak XCTestExpectation * expectation     = [self expectationWithDescription:@"Block Storage - volume exist"];
...
- ( void ) testINAPBStorageCreateUpdateMetadataThenDestroyVolume
{
...
- ( void ) testINAPBStorageCreateExtendThenDestroyVolume
{
    __weak XCTestExpectation * expectation     = [self expectationWithDescription:@"Block Storage - volume exist"];
...
//INAP doesn't authorize updating metadata as action, Snapshot nor Backup on Volume by default
/*
- ( void ) testINAPBStorageCreateSetAndUnsetMetadataThenDestroyVolume
{
...
- ( void ) testINAPBStorageCreateListAndDeleteBackup
{
...
- ( void ) testINAPBStorageCreateListAndDeleteSnapshot
{
